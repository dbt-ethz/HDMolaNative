...
namespace Mola
{
    ...
    public struct Color : IEquatable<Color>, IFormattable
    {
        ...
        public string ToString(string format, IFormatProvider formatProvider)
        {
            ...
            return r.ToString(format, formatProvider)+" "+ g.ToString(format, formatProvider) + " " + b.ToString(format, formatProvider) + " " + a.ToString(format, formatProvider);
        }
        ...
        {
            return ((Vec4)this).GetHashCode();
        }
        // Colors can be implicitly converted to and from [[Vec4]].
